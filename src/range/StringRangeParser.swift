class StringRangeParser {
     ...
     */
    public static func rangeOf(_ a: String, _ b: String) -> Range<String.Index>? {/*<--New: add optional return */
        return a.range(of: b)//upgraded to swift 3
    }
    /**
     * Returns a Range instance for PARAM: str from PARAM: start to PARAM: end
     */
    public static func stringRange(_ str: String, _ start: Int, _ end: Int) -> Range<String.Index> {
        return strRange(str, start, end - start)
    }
    /**
     * Returns a Range instance for PARAM: str from PARAM: i to PARAM: i + PARAM: len
     */
    public static func strRange(_ str: String, _ i: Int, _ len: Int) -> Range<String.Index> {
